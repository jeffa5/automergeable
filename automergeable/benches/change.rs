...
fn bench_single(mut document: Document<HashMap<String, String>, Frontend>, limit: usize) {
    black_box(
        document
...
fn bench_many(mut document: Document<HashMap<String, String>, Frontend>, limit: usize) {
